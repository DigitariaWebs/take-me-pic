...
| TASK-015 | UI fixes: input alignment, keyboard overlap, active toggle | Done | Agent | P2 |
| TASK-016 | UX: button loading states, language dropdown, remove two controls | Done | Agent | P2 |
